        ...
        <div className={Styles.footer}>
            <div className={Styles.logosection}>
                ...
                <div className={Styles.icons}>
                    <FacebookIcon onClick={()=> window.open("https://www.facebook.com/ambhos.official/")}/>
                    <InstagramIcon onClick={()=> window.open("https://www.instagram.com/ambhos_official")}/>
                    <LinkedInIcon onClick={()=> window.open("https://www.linkedin.com/company/ambhos")}/>
                </div>
